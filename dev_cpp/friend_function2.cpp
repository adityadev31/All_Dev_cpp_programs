...
class A{
	...
	public:
		...
		friend void editor(A &,B &,C &); //declaring friend function//  //friend  function(class name ,class name)  
                                   ...
                                   // use & when want to change actual members
...
int main(){
	...
	o2.show_data();
	o3.show_data();
	cout<<"now there is change in actual members.......";
	return 0;
}

//note this is not the copy of class members .......hence change in actual members.......
